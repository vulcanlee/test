using bzPubMedSearchViewModel.Models;
...
namespace bzPubMedSearchViewModel.ViewModels
{
    public class PubMedSearchBuilderViewModel
    {
        public List<FieldNameItem> FieldNameItems { get; set; }
        public List<ConditionBuilderItem> ConditionBuilderItems { get; set; }
        public string QueryCondition { get; set; }
        public Action StateHasChangedHandler { get; set; }
